...
import com.project.iBook.paypal.CaptureIntentExamples.CaptureOrder;
import com.project.iBook.paypal.CaptureIntentExamples.CreateOrder;
...
public class PaypalServiceImpl implements PaypalService {
    @Override
    public Result checkout(double price) {
        try {
            // Creating Order
            HttpResponse<Order> orderResponse = new CreateOrder().createOrder(false, price);
            String orderId = "";
            ...
            if (orderResponse.statusCode() == 201) {
                ...
                for (LinkDescription link : orderResponse.result().links()) {
                    ...
                    if (link.rel().equals("approve")) {
                        return Result.success(link.href());
                    }
                }
            }
...
//            }
        ...
        return Result.fail(500, "transaction fail!");
    }
}
